...
ALTER TABLE products ADD COLUMN IF NOT EXISTS domain TEXT NOT NULL DEFAULT 'commerce';
ALTER TABLE products ADD CONSTRAINT products_domain_check CHECK (domain IN ('commerce','distribution','technologie','international'));
